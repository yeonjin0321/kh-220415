...
public class EmpSumList2 extends JFrame implements ActionListener {
	JButton jbtn_select = new JButton("조회"); //이벤트 처리할 버튼.
	...
	DBConnectionMgr dbMgr = new DBConnectionMgr(); //뷰2 디비커넥션을 빌려옴.
	...
	public List<Map<String,Object>> getEmpSumList2() {
		System.out.println("getSumEmpList2 initDisplay 호출 성공");
	...
	public void initDisplay() {
		...
		this.add("South",jbtn_select);
		this.add("Center",jsp); // 스크롤 쌓아가는것
		this.setSize(500,400);
		this.setVisible(true);
	}
	
	public static void main(String[] args) {
		new EmpSumList2(); //메인메소드 호출
	}
	...
	public void actionPerformed(ActionEvent e) { 
		...
		if(obj == jbtn_select) {
			System.out.println("조회 버튼을 눌렀습니다");
			getEmpSumList2();
		}
	}
